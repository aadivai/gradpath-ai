      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="glass-card rounded-2xl p-6 border border-stone-200/50 space-y-5">
            <h2 className="text-xs font-bold text-stone-850 uppercase tracking-wider border-b border-stone-200/30 pb-2">
              Cost Variables
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] text-stone-400 font-bold uppercase tracking-wider block">Degree Duration</label>
                <select 
                  value={duration} 
                  onChange={e => setDuration(Number(e.target.value))} 
                  className="w-full border border-stone-200 rounded-xl px-3 py-2 text-xs font-bold text-stone-800 focus:outline-indigo-600 bg-white"
                >
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-stone-500 font-bold">Monthly Rent & Living (USD)</span>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-stone-500 font-bold">Annual Health Insurance (USD)</span>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs">
                  <span className="text-stone-500 font-bold">One-time Flight Costs (USD)</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[10px] text-stone-400 font-bold uppercase tracking-wider block">Visa & SEVIS Fee (USD)</label>
                  <input
                    type="number"
                    value={visa}
                ...
                <div className="space-y-1">
                  <label className="text-[10px] text-stone-400 font-bold uppercase tracking-wider block">Annual Miscellaneous (USD)</label>
                  <input
                    type="number"
                    value={misc}
          ...
          <div className="glass-card rounded-2xl p-6 border border-stone-200/50 space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full h-2 bg-stone-100 rounded-full overflow-hidden relative border border-stone-250/20">
              ...
              <div>
                ...
                <div className="w-full h-2 bg-stone-100 rounded-full overflow-hidden relative border border-stone-250/20">
                  <div className="h-full bg-slate-500 rounded-full transition-all duration-300" style={{ width: `${percentMisc}%` }} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-6">
          ...
          <div className="glass-card rounded-2xl p-5 border border-stone-200/50 bg-amber-50/40 text-amber-800 space-y-3">
            ...
            <ul className="space-y-2.5 text-xs text-amber-700/90 leading-relaxed font-semibold">
