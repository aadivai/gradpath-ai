    ...
    <div className="max-w-6xl mx-auto px-6 py-10 space-y-6">
      ...
      <div className="border-b border-border/40 pb-4">
        <h1 className="text-2xl font-black text-foreground tracking-tight flex items-center gap-2">
          <Luggage className="w-6 h-6 text-indigo-600 animate-pulse" />
          Relocation Assistant
        </h1>
        <p className="text-xs text-muted-foreground mt-1">
          Post-admission logistics hub. Organize housing deposits, bank accounts, local SIMs, and manage your relocation checklist.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-card border border-border rounded-2xl p-5 shadow-xs flex flex-col min-h-[460px]">
          
          {/* Tabs Selector list */}
          <div className="flex bg-muted/50 border border-border p-1 rounded-xl text-[10px] font-bold uppercase tracking-wider mb-5 overflow-x-auto select-none scrollbar-none">
            {[
          ...
          <div className="flex-1 text-xs leading-relaxed space-y-4 pr-1">
            ...
            {activeTab === 'housing' && (
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-bold text-foreground">Securing Student Housing</h3>
                ...
                <div className="space-y-3 pt-2">
                  <div className="p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground">Option A: University Studentenwerk / Dorms (Recommended)</p>
                    <p className="text-muted-foreground mt-1 leading-normal font-semibold">
                  ...
                  <div className="p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground">Option B: Private Shared Housing (WG / Homestays)</p>
                ...
                <div className="bg-amber-50/50 dark:bg-amber-950/20 border border-amber-500/20 rounded-xl p-3.5 text-amber-800 dark:text-amber-300">
                  <p className="font-bold uppercase tracking-wider text-[9px] text-amber-700 dark:text-amber-400">Important Alert</p>
            ...
            {activeTab === 'bank' && (
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-bold text-foreground">Setting up Blocked Accounts & Local Banking</h3>
                ...
                <div className="space-y-3 pt-2">
                  <div className="p-3.5 border border-border rounded-xl bg-card space-y-1.5">
                    <p className="font-bold text-foreground">Germany: Blocked Account ("Sperrkonto")</p>
                  ...
                  <div className="p-3.5 border border-border rounded-xl bg-card space-y-1.5">
                    <p className="font-bold text-foreground">Canada: GIC (Guaranteed Investment Certificate)</p>
                ...
                <div className="p-3 bg-muted rounded-xl border border-border/50">
                  <p className="font-bold text-foreground flex items-center gap-1.5 text-indigo-650">
                    <CheckCircle className="w-4 h-4" /> Permanent Local Accounts
                  </p>
                  <p className="text-muted-foreground mt-1 leading-normal font-semibold">
            ...
            {activeTab === 'sim' && (
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-bold text-foreground">Acquiring a Local Mobile Connection</h3>
                ...
                <div className="space-y-3 pt-2">
                  <div className="p-3 bg-muted rounded-xl border border-border/50 space-y-1">
                    <p className="font-bold text-foreground">Prepaid SIM Cards (Highly Recommended First Step)</p>
                    <p className="text-muted-foreground leading-normal">
                  ...
                  <div className="p-3 bg-muted rounded-xl border border-border/50 space-y-1">
                    <p className="font-bold text-foreground">Contract Postpaid SIMs (24 Months)</p>
                    <p className="text-muted-foreground leading-normal font-semibold">
                ...
                <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-3 flex items-start gap-2 text-indigo-800 dark:text-indigo-300">
            ...
            {activeTab === 'packing' && (
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-bold text-foreground">Packing Matrix</h3>
                  <p className="text-muted-foreground mt-1 font-medium">Core essentials for student relocations.</p>
                </div>

                <div className="grid grid-cols-2 gap-4 text-xs pt-1">
                  <div className="space-y-2 p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground border-b border-border/50 pb-1 uppercase tracking-wider text-[9px] text-indigo-650">Hand Luggage (Must-haves)</p>
                  ...
                  <div className="space-y-2 p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground border-b border-border/50 pb-1 uppercase tracking-wider text-[9px] text-indigo-650">Checked Baggage</p>
                    <ul className="space-y-1 text-muted-foreground font-semibold">
            ...
            {activeTab === 'airport' && (
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-bold text-foreground">Airport Arrival & Border Control Procedures</h3>
                  <p className="text-muted-foreground mt-1 font-medium">What to expect when landing in your target destination country.</p>
                </div>

                <div className="space-y-3 pt-2">
                  <div className="p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground">1. Border Control Interview</p>
                    <p className="text-muted-foreground mt-1 leading-normal">
                  ...
                  <div className="p-3 bg-muted rounded-xl border border-border/50">
                    <p className="font-bold text-foreground">2. Study Permit Issuance (Canada/USA)</p>
                    <p className="text-muted-foreground mt-1 leading-normal font-semibold">
        ...
        <div className="lg:col-span-5 bg-card border border-border rounded-2xl p-5 shadow-xs space-y-5 flex flex-col justify-between">
          ...
          <div className="space-y-3">
            <div className="border-b border-border/40 pb-3 flex items-center justify-between">
              ...
              <span className="text-xs font-black text-indigo-650">{progress}% Done</span>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-muted-foreground text-right font-medium">
                {checkedIds.length} of {DEFAULT_TASKS.length} tasks completed
              </p>
            </div>

            {/* Checklist items */}
            <div className="space-y-2.5 pt-3 max-h-72 overflow-y-auto pr-1">
              {DEFAULT_TASKS.map(task => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left flex items-start gap-2.5 px-3 py-2.5 bg-muted/40 hover:bg-muted rounded-xl border border-border/40 hover:border-indigo-500/20 text-xs font-medium transition-all group cursor-pointer"
                  >
          ...
          <div className="bg-amber-50/40 dark:bg-amber-950/20 rounded-xl p-4 border border-border text-amber-800 dark:text-amber-300 space-y-2 mt-4">
