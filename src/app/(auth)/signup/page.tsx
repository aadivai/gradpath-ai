      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-muted-foreground mt-2 font-medium">
            Join the Study Abroad AI Operating System
          </p>
        </div>
          ...
          {success ? (
            <div className="text-center space-y-4 py-6">
              ...
              <div className="pt-2">
                <Link
                  href="/login"
                  className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs inline-flex items-center gap-1 shadow-md shadow-indigo-500/10 cursor-pointer"
                >
            ...
            <>
              <div>
                <h2 className="text-lg font-bold text-foreground">Get started free</h2>
                <p className="text-xs text-muted-foreground mt-1 font-semibold">
                  Create your profile and start planning your abroad journey today.
                </p>
              </div>
